...
namespace Infraestructura.Data.SqlServer.Pedido
{
    public class Pedido_DAL
    {
        ...
        public List<DetallePedidoClienteDTO> ObtenerHistorialCliente(int idUser)
        {
            return EjecutarConsultaHistorialCliente("usp_HistorialPedidosUsuario", new SqlParameter("@idUser", idUser));
        }
        ...
        private List<DetallePedidoClienteDTO> EjecutarConsultaHistorialCliente(string nombreSP, params SqlParameter[] parametros)
        {
            List<DetallePedidoClienteDTO> lista = new List<DetallePedidoClienteDTO>();
            ...
            using (var cnx = cn.Conectar())
            {
                ...
                try
                {
                    ...
                    using (SqlDataReader dr = cmd.ExecuteReader())
                    {
                        while (dr.Read())
                        {
                            lista.Add(MapearDetallePedidoCliente(dr));
                        }
                    }
                }
                catch (Exception ex)
        ...
        private DetallePedidoClienteDTO MapearDetallePedidoCliente(SqlDataReader dr)
        {
